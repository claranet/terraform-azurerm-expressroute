...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 543bb93

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 100183b
* **deps:** update dependency tflint to v0.64.0 d38a1ba
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template c7a31a2
* **v9:** 🐛 synchronize common files and docs 6c6e043

## 8.0.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug dc7bbcf

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 833c505
* **deps:** update dependency opentofu to v1.12.2 5852d8c
* **deps:** update dependency opentofu to v1.12.3 5ee56ee
* **deps:** update dependency opentofu to v1.12.4 73022da
* **deps:** update dependency tflint to v0.63.1 3cdd1f8
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 1ced3bb
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 69390e1

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ f0e50a0

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 5194c09
* **deps:** update dependency opentofu to v1.11.7 1fa7720
* **deps:** update dependency opentofu to v1.12.0 734e2fc
* **deps:** update dependency terraform-docs to v0.23.0 9bf96f7
* **deps:** update dependency terraform-docs to v0.24.0 7c4e511
* **deps:** update dependency tflint to v0.62.1 35f6322
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 d1bd2ad
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 7c35225
* **deps:** update tools cb90be8
* **pre-commit:** 🔧 move to prek 0f6e066
* **tfdocs:** bump tfdocs to v0.22 🔧 fcf5a9f

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 040e055

### Code Refactoring

* update module structure and Github actions 👷 84d47a3

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 0173a30
* **deps:** 🔗 bump tflint rules version 7d28849
* **deps:** update dependency trivy to v0.69.2 bfdbca6
* **deps:** update dependency trivy to v0.69.3 6012ff5
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 a51f5f0

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 447588b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 c3b6f60
* **deps:** update dependency opentofu to v1.11.2 33bcd9b
* **deps:** update dependency opentofu to v1.11.3 92814aa
* **deps:** update dependency opentofu to v1.11.4 0080d3d
* **deps:** update dependency opentofu to v1.11.5 f7d3151
* **deps:** update dependency pre-commit to v4.4.0 a372dad
* **deps:** update dependency pre-commit to v4.5.0 5014146
* **deps:** update dependency pre-commit to v4.5.1 009ef53
* **deps:** update dependency tflint to v0.60.0 f4e1bf0
* **deps:** update dependency tflint to v0.61.0 94b47d4
* **deps:** update dependency trivy to v0.67.1 5d0a50e
* **deps:** update dependency trivy to v0.67.2 9cdccea
* **deps:** update dependency trivy to v0.68.1 22bd46c
* **deps:** update dependency trivy to v0.68.2 ee091c9
* **deps:** update dependency trivy to v0.69.0 c27d836
* **deps:** update dependency trivy to v0.69.1 e671d67
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 0b6055a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 a1142b5
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 d310777
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 736cfd6
* **deps:** update tools c011b76

## 8.0.1 (2025-09-30)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 2672a94

### Miscellaneous Chores

* **⚙️:** ✏️ update template identifier for MR review 42256a8
* 🗑️ remove old commitlint configuration files 997be44
* **deps:** 🔗 bump AzureRM provider version to v4.31+ 73e4376
* **deps:** update dependency claranet/diagnostic-settings/azurerm to ~> 8.1.0 3ca8d21
* **deps:** update dependency opentofu to v1.10.0 c747b50
* **deps:** update dependency opentofu to v1.10.1 5206c66
* **deps:** update dependency opentofu to v1.10.3 e6732aa
* **deps:** update dependency opentofu to v1.10.6 a8e1a35
* **deps:** update dependency opentofu to v1.9.1 f66fd80
* **deps:** update dependency pre-commit to v4.1.0 4049d4a
* **deps:** update dependency pre-commit to v4.2.0 7eff80b
* **deps:** update dependency terraform-docs to v0.20.0 27afc9a
* **deps:** update dependency tflint to v0.57.0 6126b26
* **deps:** update dependency tflint to v0.58.0 26b33af
* **deps:** update dependency tflint to v0.58.1 8a10bcd
* **deps:** update dependency tflint to v0.59.1 bf12b48
* **deps:** update dependency trivy to v0.59.1 273aa7f
* **deps:** update dependency trivy to v0.60.0 2e0b338
* **deps:** update dependency trivy to v0.61.1 21540ad
* **deps:** update dependency trivy to v0.62.0 867f0eb
* **deps:** update dependency trivy to v0.62.1 244ce42
* **deps:** update dependency trivy to v0.63.0 d8a50d5
* **deps:** update dependency trivy to v0.66.0 ce995e3
* **deps:** update dependency trivy to v0.67.0 bf1b59f
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.21.0 81ab79e
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.22.0 f68160c
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 b5c3385
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.0 3bf33b3
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.1 7ef47d3
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 6e348e6
* **deps:** update terraform claranet/subnet/azurerm to ~> 8.1.0 452ea98
* **deps:** update tools 5e3d461
* **deps:** update tools 97a02de
* **deps:** update tools 5148a1f
* **deps:** update tools 8a15d5b
* **deps:** update tools f37c094
* update Github templates 4d0940f
